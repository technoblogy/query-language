; The ATtiny database v2 - 6th April 2019
; with 1-off prices (in pence) from https://uk.farnell.com/
...
(defvar *data*
  '((attinyX5 (pins 8) (io 5) (adc 4) (pwm 3) (usi 1) (timer8 2) (crystal) (pll))
    ...
    (attiny1634 (family attinyX34) (flash 16384) (ram 1024) (eeprom 256) (price tqfp 116))
